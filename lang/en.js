...
export default {
	meta: {
		...
		ogDescription:
			"Find the best metro routes, ticket fares, travel time, and intermediate stations easily.",
	...
	footer: {
		...
		qrDescription:
			"Scan the QR code to quickly open this application on your mobile device.",
		...
		disclaimer:
			"Route, fare and travel information are provided for reference only.",
